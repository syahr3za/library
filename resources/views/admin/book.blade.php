...
<div id="controller">
	...
	<div class="row">
		<div class="col-md-4 col-sm-5 col-xs-12" v-for="book in filteredList">
	...
	<div class="modal fade" id="modal-default">
		<div class="modal-dialog">
			<div class="modal-content">
				<form method="POST" :action="actionUrl" @submit="submitForm($event, book.id)" autocomplete="off">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<select name="publishers_id" class="form-control">
								@foreach($publishers as $publisher)
								<option :selected="book.publishers_id == {{ $publisher->id }}" value="{{ $publisher->id }}">{{ $publisher->name }}</option>
								@endforeach
							</select>
						</div>	
						<div class="form-group">
